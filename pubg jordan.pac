...
var JORDAN_MATCH_IPV4 = [
  ...
  // ── Orange Jordan / Jordan Telecom (AS8697) ──────────────────
  // الأفضل ثباتاً ← أعلى أولوية
  ["86.108.0.0",    "255.255.128.0"],   // Orange JO - Infra
  ["92.253.0.0",    "255.255.128.0"],   // Orange JO - Core
  ["46.185.128.0",  "255.255.128.0"],   // Orange JO - Broadband
  ["37.202.64.0",   "255.255.192.0"],   // Orange JO - Mobile
  ["194.165.128.0", "255.255.224.0"],   // Orange JO - Business
  ["213.186.160.0", "255.255.224.0"],   // Orange JO - Enterprise
  ["82.212.0.0",    "255.255.0.0"],     // Jordan Telecom Legacy
  ["212.34.0.0",    "255.255.0.0"],     // Jordan Telecom Core
  ["194.126.16.0",  "255.255.240.0"],   // Jordan Data Communications

  // ── Umniah (AS47887) ─────────────────────────────────────────
  ["46.34.192.0",   "255.255.192.0"],   // Umniah Broadband
  ["109.224.0.0",   "255.255.0.0"],     // Umniah Core

  // ── Zain Jordan (AS9038) ─────────────────────────────────────
  ["37.98.128.0",   "255.255.128.0"],   // Zain JO Broadband
  ["212.118.64.0",  "255.255.192.0"],   // Zain JO Core
  ["80.90.172.0",   "255.255.255.0"],   // Zain JO Legacy

  // ── DATACOM / Cyber City / iConnect ──────────────────────────
  ["212.35.192.0",  "255.255.192.0"],   // DATACOM Jordan (AS9051)
  ["212.35.66.0",   "255.255.255.0"],   // DATACOM - Proxy Host
  ["185.62.136.0",  "255.255.252.0"],   // iConnect Jordan (AS204136)
  ["91.187.0.0",    "255.255.192.0"],   // Cyber City Telecom (AS39386)

  // ── Batelco / VTEL / Roya ────────────────────────────────────
  ["185.93.244.0",  "255.255.252.0"],   // Batelco Jordan / Damamax
  ["185.14.192.0",  "255.255.252.0"],   // VTEL Holdings (AS199430)
  ["185.45.8.0",    "255.255.252.0"],   // Roya Communications (AS200478)
  ["178.20.186.0",  "255.255.255.0"],   // VTEL Legacy
  ["81.28.124.0",   "255.255.255.0"],   // AL-HADATHEH CO.

  // ── Palestine (تمر عبر JO-IX بشكل شبه دائم) ─────────────────
  ["188.161.0.0",   "255.255.0.0"],     // Paltel (AS12975)
  ["82.205.0.0",    "255.255.128.0"],   // Paltel Core
  ["37.76.0.0",     "255.255.0.0"],     // Jawwal / Wataniya (AS57704)
  ["185.31.208.0",  "255.255.252.0"]    // MADA Palestine
];
...
var JORDAN_WIDE_IPV4 = [
  ...
  ["194.126.16.0",  "255.255.240.0"],
  ["46.34.192.0",   "255.255.192.0"],
  ["109.224.0.0",   "255.255.0.0"],
  ["37.98.128.0",   "255.255.128.0"],
  ["212.118.64.0",  "255.255.192.0"],
  ["80.90.172.0",   "255.255.255.0"],
  ["212.35.192.0",  "255.255.192.0"],
  ["212.35.66.0",   "255.255.255.0"],
  ["185.62.136.0",  "255.255.252.0"],
  ["91.187.0.0",    "255.255.192.0"],
  ["185.93.244.0",  "255.255.252.0"],
  ["185.14.192.0",  "255.255.252.0"],
  ["185.45.8.0",    "255.255.252.0"],
  ["178.20.186.0",  "255.255.255.0"],
  ["81.28.124.0",   "255.255.255.0"],
  ["188.161.0.0",   "255.255.0.0"],
  ["82.205.0.0",    "255.255.128.0"],
  ["37.76.0.0",     "255.255.0.0"],
  ["185.31.208.0",  "255.255.252.0"],

  // ── Saudi Arabia (STC + Mobily — transit أحياناً عبر JO) ─────
  ["212.39.0.0",    "255.255.0.0"],     // STC Saudi (AS25019)
  ["212.48.64.0",   "255.255.192.0"],   // Mobily (AS15802)

  // ── Kuwait ───────────────────────────────────────────────────
  ["212.58.0.0",    "255.255.0.0"],     // Zain Kuwait

  // ── UAE ──────────────────────────────────────────────────────
  ["185.13.64.0",   "255.255.252.0"],   // du UAE
  ["195.229.24.0",  "255.255.248.0"]    // Etisalat UAE (AS5384)
];
